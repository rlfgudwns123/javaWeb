...
public class CustomerController 
{
	...
	public String noticeReg(Notice n, MultipartFile file, Principal principal ,
			HttpServletRequest request, SecurityContext context) throws IOException
	{
		
		if(request.isUserInRole("ROLR_ADMIN"))
		{
			
		}
		context.getAuthentication().getAuthorities();	//권한 목록 가져오기
		context.getAuthentication().isAuthenticated();	//인증 됬는지 안됬는지
